...
export default function BarterExplorePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
      ...
      <div className="bg-gradient-to-r from-[#581c2e] via-[#3b111e] to-[#581c2e] text-white rounded-3xl p-8 sm:p-12 border border-[#70243b] shadow-md mb-12 relative overflow-hidden">
        <div className="max-w-3xl relative z-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              to="/barter/requests"
              className="btn-primary text-xs py-2.5 px-4 font-bold bg-white text-stone-950 hover:bg-[#faf6f0]"
            >
              <ArrowRightLeft size={14} /> View My Barter Proposals
            </Link>
            <Link
              to="/rentals"
              className="btn-secondary text-xs py-2.5 px-4 bg-[#3b111e]/80 border-[#70243b] text-white hover:bg-[#4a1523]"
            >
        ...
        <div className="mt-10 pt-8 border-t border-white/10 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-4 bg-white/10 backdrop-blur-xs rounded-2xl border border-white/15">
            <div className="flex items-center gap-2 text-rose-200 font-bold mb-1.5">
              <BookOpen size={16} /> I Teach
            </div>
            <p className="text-white font-black text-sm">React.js Web Dev</p>
            <span className="text-[11px] text-stone-300 font-medium">3 1-on-1 Mentorship Sessions</span>
          </div>
          ...
          <div className="p-4 bg-white/5 backdrop-blur-xs rounded-2xl border border-white/10 flex flex-col justify-center items-center text-center">
            <div className="w-8 h-8 rounded-full bg-[#f59e0b] text-stone-950 flex items-center justify-center font-bold mb-1 shadow-sm">
          ...
          <div className="p-4 bg-white/10 backdrop-blur-xs rounded-2xl border border-white/15">
            ...
            <span className="text-[11px] text-stone-300 font-medium">7 Days Project Lab Use</span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-14">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-stone-950 font-display mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="cs-card p-6">
            <div className="w-9 h-9 rounded-xl bg-[#fff1f2] text-[#881337] flex items-center justify-center font-bold text-xs mb-4 border border-[#fecdd3]">
              1
            </div>
            <h3 className="font-bold text-stone-900 text-sm mb-1.5">Find Any Rental Item</h3>
          ...
          <div className="cs-card p-6">
            <div className="w-9 h-9 rounded-xl bg-[#fef3c7] text-[#92400e] flex items-center justify-center font-bold text-xs mb-4 border border-[#fde68a]">
              2
            </div>
            <h3 className="font-bold text-stone-900 text-sm mb-1.5">Propose Skill & Duration</h3>
            <p className="text-xs text-stone-500 leading-relaxed">
          ...
          <div className="cs-card p-6">
            <div className="w-9 h-9 rounded-xl bg-[#ecfdf5] text-[#166534] flex items-center justify-center font-bold text-xs mb-4 border border-[#a7f3d0]">
              3
            </div>
            <h3 className="font-bold text-stone-900 text-sm mb-1.5">Acceptance & +3 Trust Bonus</h3>
            <p className="text-xs text-stone-500 leading-relaxed">
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-lg sm:text-xl font-bold tracking-tight text-stone-950 font-display">
          ...
          <Link to="/rentals" className="text-xs font-semibold text-[#881337] hover:underline flex items-center gap-1">
                ...
                >
                  <div>
                    <div className="relative h-40 w-full bg-stone-100 overflow-hidden">
                      ...
                      <span className="absolute top-3 left-3 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-white/90 text-stone-800 backdrop-blur-xs shadow-xs">
                        {item.category}
                      </span>
                    </div>

                    <div className="p-4">
                      <h3 className="font-bold text-stone-900 text-sm line-clamp-1">{item.title}</h3>
                      <div className="mt-2 flex items-center justify-between text-xs">
                        <span className="text-stone-500">Rent: <strong className="text-stone-800">${item.pricePerDay}/day</strong></span>
                  ...
                  <div className="p-4 pt-0">
                    ...
                    >
                      <ArrowRightLeft size={13} className="text-[#b45309]" />
